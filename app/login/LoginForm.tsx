...
export default function LoginForm() {
  ...
  useEffect(() => {
    ...
    if (err === 'auth_callback') {
      ...
      setError(
        'Signed in with Google but session could not be created. Ensure Firebase Admin (FIREBASE_CLIENT_EMAIL, FIREBASE_PRIVATE_KEY) is set in .env.local.'
      )
    }
  }, [searchParams])
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg bg-white text-gray-700 font-medium hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 disabled:opacity-50 transition"
            >
              {oauthLoading === 'google' ? (
